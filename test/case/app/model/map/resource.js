  ...
  describe("safeUrl() should return safe and clickable url", () => {
    ...
    it('should have a default behavior if no protocol defined', () => {
      const checks = {
        ...
        'domain name with no protocol': {input: 'cipherguard.com', output: 'http://cipherguard.com'},
        'email address with no protocol': {input: 'test@cipherguard.com', output: 'http://test@cipherguard.com'},
        'mailto': {input: 'mailto:test@cipherguard.com', output: ''} // Is not considered as an url
      };
      checkSafeUri(checks);
    });
    ...
    it('should recognize protocols', () => {
      const checks = {
        ...
        'http': {input: 'http://cipherguard.com', output: 'http://cipherguard.com'},
        'https': {input: 'https://cipherguard.com', output: 'https://cipherguard.com'},
        'ftp': {input: 'ftp://cipherguard.com', output: 'ftp://cipherguard.com'},
    ...
    it('should not considered not parsable url as safe', () => {
      const checks = {
        'http with special character': {input: 'http://[staging/production].cipherguard.com', output: ''},
        'ssh with special character': {input: 'ssh://[staging/production]@cipherguard.com', output: ''},
      };
      checkSafeUri(checks);
    });

    it('should protect against xss uri', () => {
      // Xss based on cipherguard/mad/test/fixtures/xss.js
      const checks = {
