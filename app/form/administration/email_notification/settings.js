...
const EmailNotificationsSettingsForm = Form.extend('cipherguard.form.administration.email_notification.Settings', /** @static */ {
  ...
  _initFormRegistrationSection: function() {
    this.addElement(
      new ToggleButtonComponent('#js-send-user-create-toggle-button', {
        label: __("When new users are invited to cipherguard, notify them."),
