...
const App = Component.extend('cipherguard.component.App', /** @static */ {
  ...
  _initWorkspace: function(name, options) {
    ...
    const workspaceOptions = {
      id: `js_cipherguard_${name}_workspace_controller`,
      label: name
    };
  ...
  '{window} p3_narrow_checked': function() {
    MadBus.trigger('cipherguard.html_helper.window_resized');
  },
