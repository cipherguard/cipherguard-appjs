...
const PasswordCategoriesGroupsList = GroupsListComponent.extend('cipherguard.component.PasswordCategoriesGroupsList', /** @static */ {
   ...
   * @param {cipherguard.model.Group} group The group to filter the workspace with
   */
