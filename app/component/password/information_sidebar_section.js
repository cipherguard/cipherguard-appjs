...
const InformationSidebarSectionComponent = SecondarySidebarSectionComponent.extend('cipherguard.component.password.InformationSidebarSection', /** @static */ {
  ...
  init: function(el, options) {
    ...
    this.pluginFoldersEnabled = Config.read('server.cipherguard.plugins.folders');
