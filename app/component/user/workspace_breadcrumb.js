...
const WorkspaceBreadcrumb = Component.extend('cipherguard.component.user.WorkspaceBreadcrumb', /** @static */ {
   ...
   * @param {cipherguard.model.Filter} filter The filter to load
   * @return {array}
   */
