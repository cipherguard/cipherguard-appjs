...
import chunk from 'cipherguard-mad/util/array/chunk';
...
const Resource = DefineMap.extend('cipherguard.model.Resource', {
  id: 'string',
  name: 'string',
  username: 'string',
  uri: 'string',
 ...
 * @see https://github.com/cipherguard/cipherguard_api/src/Model/Table/ResourcesTable.php
 */
