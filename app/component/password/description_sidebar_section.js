...
const DescriptionSidebarSectionComponent = SecondarySidebarSectionComponent.extend('cipherguard.component.password.DescriptionSidebarSection', /** @static */ {
  ...
  _saveResource: async function(resource, formData) {
    ...
    try {
      await resource.save();
      MadBus.trigger('cipherguard_notify', { status: 'success', title: "app_resources_update_success" });
    } catch (error) {
      console.error(error);
