...
const FoldersFilterSidebarSectionComponent = PrimarySidebarSectionComponent.extend('cipherguard.component.password.FoldersFilterSidebarSection', /** @static */ {
   ...
   * @param {HTMLEvent} ev The event which occurred
   */
  '{document} cipherguard.plugin.folders.select-and-scroll-to': function(el, ev) {
