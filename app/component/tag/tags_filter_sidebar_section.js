...
const TagsFilterSidebarSectionComponent = PrimarySidebarSectionComponent.extend('cipherguard.component.tag.TagsFilterSidebarSection', /** @static */ {
   ...
   * @param {HTMLEvent} ev The event which occurred
   * @param {cipherguard.model.Resource} resource The updated resource
   */
