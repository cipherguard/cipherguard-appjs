...
const NotificationComponent = Component.extend('cipherguard.component.footer.Notification', /** @static */ {
  ...
  /**
   * Listen the event cipherguard_notify and display load the corresponding notification.
   * @param {HTMLElement} el The element the event occurred on
   * @param {HTMLEvent} ev The event which occurred
   * @deprecated
   */
  '{mad.bus.element} cipherguard_notify': function(el, ev) {
