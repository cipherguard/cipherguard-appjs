...
const SettingsWorkspaceMenu = Component.extend('cipherguard.component.settings.WorkspacePrimaryMenu', /** @static */ {
  defaults: {
  ...
  '{publicKeyButton.element} click': function() {
    MadBus.trigger('cipherguard.settings.download_public_key');
  },
  ...
  '{privateKeyButton.element} click': function() {
    MadBus.trigger('cipherguard.settings.download_private_key');
  }
});
