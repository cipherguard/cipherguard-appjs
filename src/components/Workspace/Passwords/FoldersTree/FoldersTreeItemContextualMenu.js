...
class FoldersTreeItemContextualMenu extends React.Component {
  ...
  handleRenameFolderItemClickEvent() {
    ...
    Plugin.send('cipherguard.plugin.folders.open-rename-dialog', {folderId});
    this.destroy();
  }
  ...
  handleExportFolderItemClickEvent() {
    const foldersIds = [this.props.folder.id];
    Plugin.send("cipherguard.plugin.export_resources", {"folders": foldersIds});
    this.destroy();
  }
  ...
  handleDeleteFolderItemClickEvent() {
    ...
    const folderId = this.props.folder.id;
    Plugin.send('cipherguard.plugin.folders.open-delete-dialog', {folderId});
    this.destroy();
  }
